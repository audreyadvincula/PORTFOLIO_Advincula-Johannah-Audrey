...
if (isset($_POST['trans'])) {
    header("Location: INTCAFE_transaction.php");
    exit();
}

if (isset($_POST['db'])) {
    header("Location: INTCAFE_admin.php");
    exit();
}
?>
...
<body>
    <form method="POST" action="">
        <label>Please specify your purpose:</label>
        <button type="submit" name="trans">Transaction</button>
        <div class="separator" >-- or --</div>
        <button type="submit" name="db">Database System</button>
    </form>
</body>
</html>
